        ...
        <div className="space-y-8">
            ...
            <div>
                <div className="flex items-center gap-4 text-sm text-gray-500 mb-4">
                    <Link href={`/admin/events/${slug}`} className="hover:text-brand-red flex items-center gap-1 transition-colors">
                ...
                <div className="flex items-center gap-4">
                    ...
                    <div>
                        <h1 className="text-3xl font-bold text-brand-navy">Winner Selection</h1>
