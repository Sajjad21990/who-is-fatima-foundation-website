            ...
            <div className="relative grid lg:grid-cols-2 gap-8 p-8 lg:p-12">
              ...
              <div className="flex flex-col justify-center space-y-6">
                <div className="flex items-center gap-3">
                  <span className="bg-[#E63946] text-white text-xs font-bold tracking-widest uppercase px-3 py-1.5 rounded-full">
                    Flagship Initiative
                  </span>
                </div>
                ...
                <Link href="/projects">
                  <Button className="bg-[#E63946] hover:bg-[#d32f3d] text-white gap-2 px-6 mt-2">
                    Learn More
